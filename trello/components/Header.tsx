...
const Header = () => {
  return (
    <header>
      <div className="flex flex-col md:flex-row items-center p-2 bg-gray-500/10 rounded-b-2x1">
        {/* gradient bg color for header  */}
        ...
        <div className="flex items-center space-x-5 flex-1 justify-end w-full">
          ...
          {/* Avatar */}
          <Avatar name="Med Slh" round size="50" color="#0055D1" />
        </div>
      </div>
